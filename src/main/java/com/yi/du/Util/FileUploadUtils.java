...
import com.yi.du.exception.FileSaveException;
...
public class FileUploadUtils {
    ...
    public static final String DOWNLOAD_VIDEO_PATH = DOWNLOAD_PATH + "/video/";
    public static final String DATA_PATH = "/data/";

    public static final String[] IMAGE_SUFFIX = {"jpeg", "jpg", "png", "gif"};
    public static final String[] WORD_SUFFIX = {"txt", "doc", "docx"};
    public static final String[] VIDEO_SUFFIX = {"mp4", "flv"};
    ...
    public String getFilePath(MultipartFile file) {
        return getFilePath(file, DOWNLOAD_FILE_PATH, null);
    }
    ...
    public String getVideoPath(MultipartFile file) {
        return getFilePath(file, DOWNLOAD_VIDEO_PATH, VIDEO_SUFFIX);
    }
